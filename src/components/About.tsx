    ...
    >
      ...
      <div className="container-wide grid gap-16 lg:grid-cols-[1.15fr,1.1fr] lg:items-start">
        ...
        <div className="space-y-6">
          <div className="relative overflow-hidden rounded-[2.5rem] bg-white p-2 shadow-soft transition-transform duration-500 hover:scale-[1.01]">
            <div className="grid gap-4 p-4 sm:p-6 lg:grid-cols-[1.5fr,1fr]">
              {/* Grande image principale - Prend toute la hauteur disponible */}
              <div className="relative h-full min-h-[300px] overflow-hidden rounded-[1.8rem] bg-gray-100">
                {data.image_url && (
                  <img
                    src={data.image_url}
                    alt="Équipe JAWA"
              ...
              <div className="flex flex-col gap-4 justify-between h-full">
                <div className="relative flex-1 flex flex-col justify-center overflow-hidden rounded-[1.8rem] bg-jawaBlack text-white p-6 shadow-lg shadow-jawaBlack/10">
                ...
                <div className="relative flex-1 flex flex-col justify-center overflow-hidden rounded-[1.8rem] bg-gray-50 border border-gray-100 p-6 shadow-sm">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400">
                    Expertise
                  </p>
                  <p className="mt-2 text-sm font-medium text-neutral-800 leading-relaxed">
                    Une synergie parfaite entre <span className="text-primary">Design</span> et <span className="text-primary">Tech</span> pour des produits d'exception.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Bandeau équipe */}
          <div className="flex flex-col gap-4 rounded-[2rem] bg-[#FFE04A] px-8 py-6 shadow-lg shadow-[#FFE04A]/20 sm:flex-row sm:items-center sm:justify-between transition-transform duration-300 hover:-translate-y-1">
            <div>
              <p className="text-base font-bold text-jawaBlack">
                Les talents derrière JAWA
              </p>
              <p className="text-xs font-medium text-jawaBlack/70 mt-0.5">
            ...
            <div className="flex -space-x-3">
              {Array.from({ length: 5 }).map((_, i) => (
                <div
                  key={i}
                  className="h-10 w-10 rounded-full border-2 border-[#FFE04A] bg-jawaBlack/90 shadow-sm"
                />
              ))}
              <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#FFE04A] bg-white text-xs font-bold text-jawaBlack">
                +
              </div>
            </div>
          </div>
        ...
        <div className="space-y-10 lg:pt-8">
          <div>
            <h2 className="section-title text-jawaBlack leading-tight">
              {data.intro_title}
            </h2>
            <p className="section-subtitle text-lg leading-relaxed text-neutral-600">
              {data.intro_text}
            </p>
          </div>

          <div className="space-y-4">
            <div className="group cursor-default rounded-2xl border border-transparent p-4 transition-all hover:border-gray-100 hover:bg-gray-50">
              <h3 className="flex items-center gap-4 text-lg font-bold text-jawaBlack">
              ...
              <div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-500 group-hover:grid-rows-[1fr]">
                <div className="overflow-hidden">
                  <p className="mt-4 text-neutral-600 leading-relaxed pl-[3.5rem]">
                    {data.history_text}
                  </p>
                </div>
              </div>
